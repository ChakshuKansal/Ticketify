    ...
    <div>
      <div>
        <div className="text-center font-semibold leading-10">
          <h1 className="text-5xl leading-10 tracking-wide font-bold font-sans">
            Get Started
          </h1>
          <p className="font-medium">
            Choose a plan to start listing your events. Our creator-friendly
            pricing is designed with you in mind to ensure it's easy and viable.
          </p>
        </div>
        <div className="text-center font-semibold flex flex-col justify-between gap-10 items-center mt-10">
          ...
          <div className="h-[540px] w-[400px] rounded-xl overflow-hidden shadow-md">
            ...
            <div>
              {LoggedIn ? (
                <Link to={"/Addevent"}>
                  <button className="bg-[#31C0F0] p-4 rounded-md text-zinc-50 text-lg">
                    ADD EVENT
                  </button>
                </Link>
              ) : (
      ...
      <div>
        <div className="text-center font-semibold flex flex-col justify-between gap-20 items-center mt-10">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-1 gap-10 px-16">
            <div className="h-[540px] w-[400px] rounded-xl overflow-hidden shadow-md">
              ...
              <div>
                {LoggedIn ? (
                  <Link to={"/Addevent"}>
                    <button className="bg-[#EC1066] p-4 rounded-md text-zinc-50 text-lg">
                      ADD EVENT
                    </button>
                  </Link>
                ) : (
          ...
          {!LoggedIn && (
            <h1 className="leading-10 text-xl">
